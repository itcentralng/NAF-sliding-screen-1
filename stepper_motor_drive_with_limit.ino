...
String positions[4] = {"home", "chiefs", "commanders", "commandants"};
const int MAX_STEPS = 10000; // Total steps from index 0 to index 3
const int STEPS_PER_INDEX = MAX_STEPS / 3; // Steps between each index (10000/3 ≈ 3333)
...
void setup() {
    ...
    Serial.println("Available positions: home, chiefs, commanders, commandants");
...
void parseAndExecuteCommand(String command) {
    ...
    if (targetIndex == -1) {
        Serial.println("Invalid command. Available positions: home, chiefs, commanders, commandants");
        return;
    }
